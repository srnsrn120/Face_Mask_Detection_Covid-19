...
from com_restaurant_mask_detection.predictor_yolo_detector.utils.datasets import letterbox
from com_restaurant_mask_detection.predictor_yolo_detector.utils.general import non_max_suppression, make_divisible, \
    scale_coords
